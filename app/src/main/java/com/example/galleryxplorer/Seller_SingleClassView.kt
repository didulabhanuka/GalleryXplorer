...
class Seller_SingleClassView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_seller_single_class_view)

        sellerName = findViewById(R.id.class_view_seller_name)
        itemName = findViewById(R.id.class_view_name)
        itemCategory = findViewById(R.id.class_view_category)
        itemMedium = findViewById(R.id.class_view_medium)
        itemSubject = findViewById(R.id.class_view_image_subject)
        itemYear = findViewById(R.id.class_view_image_year)
        itemSize = findViewById(R.id.class_view_image_size)
        itemPrice = findViewById(R.id.class_view_price)
        sellerId = findViewById(R.id.class_view_sellerId)
        randomId = findViewById(R.id.class_view_randomId)
        itemMainImage = findViewById(R.id.class_view_main_image)
        itemSecondImage = findViewById(R.id.class_view_second_image)
        itemThirdImage = findViewById(R.id.class_view_third_image)

        btnUpdate = findViewById(R.id.btn_class_update)
        btnDelete = findViewById(R.id.btn_class_delete)
    ...
    private fun deleteItem() {
        ...
        database.collection("sellerClassesBySellerID").document(intent.getStringExtra("sellerId").toString()).collection("sellerClasses").document(intent.getStringExtra("randomId").toString()).delete()
        database.collection("classcategory").document(intent.getStringExtra("categoryItems").toString()).collection("categoryClasses").document(intent.getStringExtra("randomId").toString()).delete()
        database.collection("allClasses")
