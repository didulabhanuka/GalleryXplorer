...
class Buyer_SingleClassView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buyer_single_class_view)

        sellerName = findViewById(R.id.user_class_view_seller_name)
        itemName = findViewById(R.id.user_class_view_name)
        itemCategory = findViewById(R.id.user_class_view_category)
        itemMedium = findViewById(R.id.user_class_view_medium)
        itemSubject = findViewById(R.id.user_class_view_image_subject)
        itemYear = findViewById(R.id.user_class_view_image_year)
        itemSize = findViewById(R.id.user_class_view_image_size)
        itemPrice = findViewById(R.id.user_class_view_price)
        itemMainImage = findViewById(R.id.user_class_view_main_image)
        itemSecondImage = findViewById(R.id.user_class_view_second_image)
        itemThirdImage = findViewById(R.id.user_class_view_third_image)
        ...
        val enrollButton: Button = findViewById(R.id.btn_class_buyNow)
        enrollButton.setOnClickListener {
            val intent = Intent(this, User_Enroll::class.java)
