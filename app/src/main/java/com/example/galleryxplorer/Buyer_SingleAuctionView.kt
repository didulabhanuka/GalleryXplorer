...
class Buyer_SingleAuctionView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buyer_single_auction_view)

        sellerName = findViewById(R.id.user_auction_view_seller_name)
        itemName = findViewById(R.id.user_auction_view_name)
        itemCategory = findViewById(R.id.user_auction_view_category)
        itemMedium = findViewById(R.id.user_auction_view_medium)
        itemSubject = findViewById(R.id.user_auction_view_image_subject)
        itemYear = findViewById(R.id.user_auction_view_image_year)
        itemSize = findViewById(R.id.user_auction_view_image_size)
        itemPrice = findViewById(R.id.user_auction_view_price)
        itemMainImage = findViewById(R.id.user_auction_view_main_image)
        itemSecondImage = findViewById(R.id.user_auction_view_second_image)
        itemThirdImage = findViewById(R.id.user_auction_view_third_image)
        ...
        val bidButton: Button = findViewById(R.id.btn_auction_bidNow)
        bidButton.setOnClickListener {
            val intent = Intent(this, User_Bid::class.java)
