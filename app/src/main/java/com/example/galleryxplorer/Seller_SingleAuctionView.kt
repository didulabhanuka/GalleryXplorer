...
class Seller_SingleAuctionView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_seller_single_auction_view)

        sellerName = findViewById(R.id.auction_view_seller_name)
        itemName = findViewById(R.id.auction_view_name)
        itemCategory = findViewById(R.id.auction_view_category)
        itemMedium = findViewById(R.id.auction_view_medium)
        itemSubject = findViewById(R.id.auction_view_image_subject)
        itemYear = findViewById(R.id.auction_view_image_year)
        itemSize = findViewById(R.id.auction_view_image_size)
        itemPrice = findViewById(R.id.auction_view_price)
        sellerId = findViewById(R.id.auction_view_sellerId)
        randomId = findViewById(R.id.auction_view_randomId)
        itemMainImage = findViewById(R.id.auction_view_main_image)
        itemSecondImage = findViewById(R.id.auction_view_second_image)
        itemThirdImage = findViewById(R.id.auction_view_third_image)

        btnUpdate = findViewById(R.id.btn_auction_update)
        btnDelete = findViewById(R.id.btn_auction_delete)
        ...
        btnUpdate.setOnClickListener {
            val intent = Intent(this, UpdateAuction::class.java)
    ...
    private fun deleteItem() {
        ...
        database.collection("sellerAuctionsBySellerID").document(intent.getStringExtra("sellerId").toString()).collection("sellerAuctions").document(intent.getStringExtra("randomId").toString()).delete()
        database.collection("auctioncategory").document(intent.getStringExtra("categoryItems").toString()).collection("categoryAuctions").document(intent.getStringExtra("randomId").toString()).delete()
        database.collection("allAuctions")
